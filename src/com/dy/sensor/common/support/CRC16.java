...
public class CRC16 {  
    ...
    public static void main(String[] args) {  
        int intCrc = CRC16.calcCrc16(new byte[] { 0x02, 0x03, (byte) 0x9d, 0x40, 0x00,
				0x02 });  
        byte[] crc = DataTypeConvert.int2byte(intCrc);
        System.out.println(ComUtil.printHexString(crc));  
        
        byte[] a =  { 0x02, 0x03, (byte) 0x9d, 0x40, 0x00,
				0x02};
        ...
        byte[] ass =  { 0x02, 0x03, (byte) 0x9d, 0x40, 0x00,
				0x02};
    }  
} 